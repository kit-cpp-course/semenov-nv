...
public:
	...
	ByteArray::size_type encrypt_start(ByteArray::size_type plain_length, ByteArray &encrypted);

	ByteArray::size_type
		encrypt_continue(const unsigned char *plain, ByteArray::size_type plain_length, ByteArray &encrypted);

	ByteArray::size_type encrypt_end(ByteArray &encrypted);

	ByteArray::size_type decrypt_start(ByteArray::size_type encrypted_length);

	ByteArray::size_type
		decrypt_continue(const unsigned char *encrypted, ByteArray::size_type encrypted_length, ByteArray &plain);
...
private:
	...
	void checkEnc(ByteArray &encrypted);

	void checkDec(ByteArray &plain);
